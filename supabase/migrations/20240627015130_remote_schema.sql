alter table "public"."recurring" add column "category_id" uuid;

alter table "public"."recurring" add constraint "recurring_category_id_fkey" FOREIGN KEY (category_id) REFERENCES categories(id) not valid;

alter table "public"."recurring" validate constraint "recurring_category_id_fkey";

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION public.calculate_recurrings()
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
  declare
